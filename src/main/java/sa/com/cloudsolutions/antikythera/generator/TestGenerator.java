...
public abstract class TestGenerator implements ITestGenerator {
    ...
    public static void addWhenThen(Expression expr) {
        GeneratorState.addWhenThen(expr);
    }
    ...
    public static List<Expression> getWhenThen() {
        return GeneratorState.getWhenThen();
    }

    public static void addImport(ImportDeclaration s) {
        GeneratorState.addImport(s);
    }
